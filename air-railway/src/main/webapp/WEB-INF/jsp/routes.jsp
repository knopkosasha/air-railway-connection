...
<div id="main">
    ...
    <div id="site_content">
        ...
        <div id="content">
            ...
            <form class="form-inline" name = "route">
                <select  id="routes">
            ...
            <form method="post" action="#" id="search_form">
                <p>
                    <input id = "destination" class="search" type="text" name="search_field" value="city" />
                    <input name="search" type="image" style="border: 0; margin: 0 0 -9px 5px;" src="./img/search.png" alt="Search" title="Search" />
                    <a href="localhost:8080/connection"> click here</a>
                </p>
            </form>
        </div>
    </div>
